...
public class EditSportSchedule extends javax.swing.JFrame {
    ...
    private final SportScheduleModel scheduleModel;
    
    /**
     * Creates new form AddSportSchedule
     */
    public EditSportSchedule(SportScheduleModel scheduleModel) {
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(cbStart, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel3)
                                .addComponent(jLabel4)
                                .addComponent(cbEnd, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(cbCoaches, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(layout.createSequentialGroup()
                            .addContainerGap()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(63, 63, 63))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cbSports1, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ArrayList<SportScheduleModel> list = new ArrayList<>();
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("schedules.txt", false));
            PrintWriter pw = new PrintWriter(bw);
            for(SportScheduleModel s: list){
                if(s.getId().equals(scheduleModel.getId())){
                    pw.println(scheduleModel.getId() + "|"+
                    ...
                    s.getCoachID()+"|"+s.getCoachName()+"|"+
                    s.getSportsCenter()+"|"+s.getStartTime()+"|"+s.getEndTime()+"|"+
                    s.getHours());
                }
            }
            bw.close();
            pw.close();
            showDialog("Sport Schedule Successfully Modified");
    ...
    private void setTimes() {
        ...
        cbStart.setSelectedItem(scheduleModel.getStartTime());
        cbEnd.setSelectedItem(scheduleModel.getEndTime());
    }

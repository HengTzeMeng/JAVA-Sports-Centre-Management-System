...
public class AddCoach extends javax.swing.JFrame {
    ...
    private void validateAndAddCoach() {
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("coaches.txt", true));
            PrintWriter pw = new PrintWriter(bw);
            pw.println(coachID+"|"+coachName+"|"+joinDate+"|"+sportsCenter+"|"+hourlyRate+"|"+phone+"|"+address
            +"|"+sport.getSportID()+"|"+sport.getSportName());
            bw.close();
            pw.close();
            showDialog("Coach Successfully Added");
            clearFields();
